...
C_ACCENT   = colors.HexColor("#1a6bbf")   # darker blue - readable on white
C_ACCENT2  = colors.HexColor("#007a66")   # darker teal - readable on white
C_GOLD     = colors.HexColor("#b8860b")   # dark gold - readable on white
C_TEXT     = colors.HexColor("#1a1a2e")   # near black - main text
C_MUTED    = colors.HexColor("#4a5568")   # dark grey - secondary text
C_SURFACE  = colors.HexColor("#f0f4f8")   # light grey surface
C_BORDER   = colors.HexColor("#cbd5e0")   # light border
C_WHITE    = colors.white
C_DANGER   = colors.HexColor("#c0392b")   # dark red - readable
C_GOOD     = colors.HexColor("#1a7a4a")   # dark green - readable
...
def generate_report_pdf(
    ...
    arch_t.setStyle(TableStyle([
        ("BACKGROUND",    (0,0), (-1,-1), C_SURFACE),
        ("BOX",           (0,0), (-1,-1), 0.5, colors.HexColor("#1a6bbf")),
    ...
    story.append(Paragraph(
        "Built by Anchal Kumar Shrivastav  •  B.Tech CSE (AI & ML)  •  SDGI Global University",
        s["footer"]
    ))
    story.append(Paragraph(
           "•  contextweave-ai-production-fed5.up.railway.app",
